...
class MasterListForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'approved_date': forms.DateTimeInput(attrs={'type': 'datetime-local', 'class': 'form-control'}),
            'reviewed_by': forms.Select(attrs={'class': 'form-control'}),
            'reviewed_date': forms.DateTimeInput(attrs={'type': 'datetime-local', 'class': 'form-control'}),
